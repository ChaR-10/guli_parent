...
import com.charlie.eduservice.client.UcenterClient;
import com.charlie.eduservice.entity.EduComment;
import com.charlie.eduservice.service.EduCommentService;
...
public class EduCommentController {
    ...
    public R addComment(HttpServletRequest request, @RequestBody EduComment eduComment){
        ...
        if (StringUtils.isEmpty(memberId)){
            throw new CharException(20001, "请先登录");
        }
